...
//     '</svg>';
OrgChart.templates.olivia.entityName = `<foreignobject data-width="240" data-marrk-field="Select_Entity" class="fs-5 font-weight-500" data-text-overflow="ellipsis" x="15" y="0" width="240" height="25" fill="#000000">{val}</foreignobject>`;
...
OrgChart.templates.olivia.company = '<foreignobject data-marrk-field="Company" data-width="240" class="fs-6" fill="#000000" width="240" height="25" x="15" y="52">{val} a ,b</foreignobject>';
...
OrgChart.templates.olivia.html_0 = '<foreignobject data-width="60" class="d-block text-end bg-white" fill="#000000" width="62" height="28" x="238" y="2">{val}</foreignobject>';
...
OrgChart.templates.ula.entityType = '<foreignobject data-width="240" data-marrk-field="Entity_Type" class="fs-6 font-weight-400" data-text-overflow="ellipsis" fill="#000000" width="240" height="25" x="15" y="18">{val}</foreignobject>';
...
OrgChart.templates.ula.html_0 = '<foreignobject data-width="60" class="d-block text-end bg-white" fill="#000000" width="62" height="28" x="238" y="2">{val}</foreignobject>';
...
OrgChart.templates.polina.html_0 = '<foreignobject data-width="60" class="d-block text-end bg-white" fill="#000000" width="62" height="28" x="238" y="2">{val}</foreignobject>';
