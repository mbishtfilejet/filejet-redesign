...
//     '</svg>';
OrgChart.templates.olivia.entityName = `<foreignobject data-width="240" data-marrk-field="Select_Entity" class="fs-5 font-weight-500" data-text-overflow="ellipsis" x="15" y="0" width="230" height="25" fill="#000000">{val}</foreignobject>`;
...
OrgChart.templates.olivia.html_0 = '<foreignobject data-width="60" class="d-block text-end" fill="#000000" width="62" height="28" x="238" y="2">{val}</foreignobject>';
...
OrgChart.templates.ula.entityName = `<foreignobject data-marrk-field="Select_Entity" data-width="230" class="fs-5 font-weight-500" data-text-overflow="ellipsis" x="15" y="0" width="230" height="25" fill="#000000">{val}</foreignobject>`;
...
OrgChart.templates.ula.html_0 = '<foreignobject data-width="60" class="d-block text-end" fill="#000000" width="62" height="28" x="238" y="2">{val}</foreignobject>';
...
OrgChart.templates.polina.entityName = `<foreignobject data-marrk-field="Select_Entity" data-width="230" class="fs-5 font-weight-500" data-text-overflow="ellipsis" x="25" y="0" width="230" height="25" fill="#000000">{val}</foreignobject>`;
OrgChart.templates.polina.entityType = '<foreignobject data-width="240" data-marrk-field="Entity_Type" class="fs-6 font-weight-400" data-text-overflow="ellipsis" fill="#000000" width="230" height="25" x="25" y="18">{val}</foreignobject>';
OrgChart.templates.polina.state = '<foreignobject data-width="240" data-marrk-field="State" class="fs-6" fill="#000000" width="230" height="25" x="25" y="35">{val}</foreignobject>';
...
OrgChart.templates.polina.html_0 = '<foreignobject data-width="60" class="d-block text-end" fill="#000000" width="62" height="28" x="238" y="2">{val}</foreignobject>';
