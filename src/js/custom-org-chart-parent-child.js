...
//     '</svg>';
OrgChart.templates.olivia.entityName = `<foreignobject data-marrk-field="Select_Entity" class="fs-5 font-weight-500" data-text-overflow="ellipsis" x="15" y="0" width="240" height="25" fill="#000000">{val}</foreignobject>`;
