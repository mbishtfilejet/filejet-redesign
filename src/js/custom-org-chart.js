...
OrgChart.templates.olivia.Compliance = '<svg width="24" height="24" x="280" y="10" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">' +
    ...
    '</svg>';
OrgChart.templates.olivia.company = ` <foreignobject data-width="240" data-marrk-field="Select_Entity" class="fs-5 font-weight-500" data-text-overflow="ellipsis" fill="#000000" width="240" height="25" x="15" y="10">{val}</foreignobject>`;
...
OrgChart.templates.polina.title = '<foreignobject data-width="240" data-marrk-field="Jurisdiction" class="fs-9" fill="#000000" width="230" height="25" x="25" y="24">&#10625; {val}</foreignobject>';
