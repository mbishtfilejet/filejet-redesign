...
OrgChart.templates.olivia.Compliance = '<svg width="24" height="24" x="280" y="10" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">' +
    ...
    '</svg>';
OrgChart.templates.olivia.company = `<g> <rect x="10" y="15" width="240" height="25" fill="" /><text data-width="230" class="fs-5 font-weight-500" fill="#000000" x="15" y="30">{val}</text></g>`;
