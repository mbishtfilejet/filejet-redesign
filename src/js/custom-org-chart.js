...
var expandAllIcon ='<span class="icon me-0 expand-all-icon"></span>';

var fitIcon = '<span class="icon me-0 fit-icon"></span>';

var zoomInIcon = '<span class="icon me-0 zoom-in-icon"></span>';

var zoomOutIcon = '<span class="icon me-0 zoom-out-icon"></span>';
