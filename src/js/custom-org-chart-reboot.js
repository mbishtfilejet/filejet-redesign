...
OrgChart.templates.additionalOwners.entityTitle = '<foreignobject data-width="240" data-marrk-field="Entity_Type" class="fs-7 font-weight-400" data-text-overflow="ellipsis" fill="#000000" width="230" height="25" x="15" y="14">{val}</foreignobject>';
OrgChart.templates.additionalOwners.html = '<foreignobject data-width="240" data-marrk-field="Entity_Type" class="fs-6 font-weight-400 bg-white" data-text-overflow="ellipsis" fill="#000000" width="230" height="50" x="15" y="35">{val}</foreignobject>';
