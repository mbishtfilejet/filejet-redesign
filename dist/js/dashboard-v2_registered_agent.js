...
$(document).on('shown.bs.tab shown.bs.modal', function () {
  ...
  const entityDetailsTables = ["entitydetails-registration-table", "entitydetails-business-table", "entitydetails-dbas-table",
    "entitydetails-ownership-table", "entitydetails-documents-table", "entitydetails-director-table", "entitydetails-opentask-table", "entitydetails-orders-table", "entitydetails-services-table", "sopNotification-table", "registeredAgent-table"]
